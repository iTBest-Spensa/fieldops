...
type Segment = {
  ...
  title: string;
  time: string;
  kind: "complete" | "current" | "next" | "available" | "break" | "travel";
  row: 0 | 1;
};
...
const technicians: Technician[] = [
  {
    ...
    track: [
      { start: 8.5, end: 10, id: "WO-001032", title: "Firewall service", time: "8:30–10:00", kind: "complete", row: 0 },
      { start: 10.5, end: 13.75, id: "WO-001037", title: "Network outage", time: "10:30–1:45", kind: "current", row: 0 },
      { start: 13.75, end: 14.17, id: "BREAK", title: "Lunch", time: "1:45–2:10", kind: "break", row: 1 },
      { start: 14.25, end: 15.5, id: "WO-001052", title: "Wi-Fi survey", time: "2:15–3:30", kind: "next", row: 0 },
      { start: 15.5, end: 17, id: "OPEN", title: "Available", time: "3:30–5:00", kind: "available", row: 1 },
    ],
    today: [
  ...
  },
  {
    ...
    track: [
      { start: 9, end: 10.25, id: "WO-001036", title: "Server check", time: "9:00–10:15", kind: "complete", row: 0 },
      { start: 10.4, end: 11, id: "TRAVEL", title: "Travelling", time: "10:25–11:00", kind: "travel", row: 1 },
      { start: 11, end: 13.5, id: "WO-001043", title: "Workstation issue", time: "11:00–1:30", kind: "current", row: 0 },
      { start: 13.5, end: 14, id: "BREAK", title: "Lunch", time: "1:30–2:00", kind: "break", row: 1 },
      { start: 14, end: 15, id: "OPEN", title: "Available", time: "2:00–3:00", kind: "available", row: 1 },
      { start: 15, end: 16.5, id: "WO-001059", title: "Desktop support", time: "3:00–4:30", kind: "next", row: 0 },
    ],
    today: [
      { time: "9:00–10:15", id: "WO-001036", title: "Server check", status: "COMPLETE" },
      { time: "10:25–11:00", id: "TRAVEL", title: "Travelling", status: "TRAVEL" },
      { time: "11:00–1:30", id: "WO-001043", title: "Workstation issue", status: "TRAVELLING" },
      { time: "1:30–2:00", id: "BREAK", title: "Lunch", status: "BREAK" },
      { time: "2:00–3:00", id: "OPEN", title: "Available", status: "OPEN" },
  ...
  },
  {
    ...
    track: [
      { start: 8, end: 9.75, id: "WO-001035", title: "Laptop setup", time: "8:00–9:45", kind: "complete", row: 0 },
      { start: 9.75, end: 12, id: "OPEN", title: "Available", time: "9:45–12:00", kind: "available", row: 1 },
      { start: 12, end: 12.5, id: "BREAK", title: "Lunch", time: "12:00–12:30", kind: "break", row: 1 },
      { start: 12.5, end: 15.25, id: "OPEN", title: "Available", time: "12:30–3:15", kind: "available", row: 1 },
      { start: 15.5, end: 16.5, id: "WO-001057", title: "User onboarding", time: "3:30–4:30", kind: "next", row: 0 },
    ],
    today: [
      { time: "8:00–9:45", id: "WO-001035", title: "Laptop setup", status: "COMPLETE" },
      { time: "9:45–12:00", id: "OPEN", title: "Available", status: "OPEN" },
      { time: "12:00–12:30", id: "BREAK", title: "Lunch", status: "BREAK" },
      { time: "12:30–3:15", id: "OPEN", title: "Available", status: "OPEN" },
  ...
  },
  {
    ...
    track: [
      { start: 8, end: 9, id: "WO-001030", title: "Router swap", time: "8:00–9:00", kind: "complete", row: 0 },
      { start: 9.5, end: 14.5, id: "WO-001039", title: "Switch replacement", time: "9:30–2:30", kind: "current", row: 0 },
      { start: 14.5, end: 15, id: "BREAK", title: "Lunch", time: "2:30–3:00", kind: "break", row: 1 },
      { start: 15, end: 16.5, id: "WO-001061", title: "Security review", time: "3:00–4:30", kind: "next", row: 0 },
    ],
    today: [
  ...
  },
  {
    ...
    track: [
      { start: 8.5, end: 11, id: "WO-001028", title: "Office deployment", time: "8:30–11:00", kind: "complete", row: 0 },
      { start: 11, end: 12.5, id: "OPEN", title: "Available", time: "11:00–12:30", kind: "available", row: 1 },
      { start: 12.5, end: 13, id: "BREAK", title: "Lunch", time: "12:30–1:00", kind: "break", row: 1 },
      { start: 13, end: 14.75, id: "OPEN", title: "Available", time: "1:00–2:45", kind: "available", row: 1 },
      { start: 14.75, end: 16.5, id: "WO-001060", title: "Rack cleanup", time: "2:45–4:30", kind: "next", row: 0 },
    ],
    today: [
      { time: "8:30–11:00", id: "WO-001028", title: "Office deployment", status: "COMPLETE" },
      { time: "11:00–12:30", id: "OPEN", title: "Available", status: "OPEN" },
      { time: "12:30–1:00", id: "BREAK", title: "Lunch", status: "BREAK" },
      { time: "1:00–2:45", id: "OPEN", title: "Available", status: "OPEN" },
...
const lineTone: Record<Segment["kind"], string> = {
          ...
          <section className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Select waiting work to compare dispatch fit. Each technician is shown as a clean activity timeline.
              </p>
            </div>
          ...
          <div className="grid gap-5 2xl:grid-cols-[300px_minmax(0,1fr)]">
            <section className="rounded-2xl border border-border bg-card/75 shadow-sm">
              <div className="border-b border-border px-4 py-4">
                ...
                <p className="mt-0.5 text-xs text-muted-foreground">Select one to rank technician fit</p>
              </div>
            ...
            <section className="min-w-0 overflow-hidden rounded-2xl border border-border bg-card/75 shadow-sm">
              <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border px-4 py-4">
                <div>
                  ...
                  <p className="mt-0.5 text-xs text-muted-foreground">
                    Jobs on the main line. Lunch, travel, breaks and availability appear underneath.
                  </p>
                </div>

                <div className="border border-primary/30 bg-primary/[0.06] px-3 py-2 rounded-none">
                  <div className="text-[10px] uppercase tracking-wider text-muted-foreground">Confidence for</div>
              ...
              <div className="overflow-x-auto">
                <div className="min-w-[1180px]">
                  <div className="grid grid-cols-[120px_190px_118px_minmax(0,1fr)] border-b border-border bg-muted/40 text-[10px] font-bold uppercase tracking-wider text-muted-foreground">
                  ...
                  <div className="grid grid-cols-[120px_190px_118px_minmax(0,1fr)] border-b border-border bg-background/30">
                  ...
                  {technicians.map((tech) => {
                    ...
                    return (
                      <div
                        key={tech.name}
                        className="grid grid-cols-[120px_190px_118px_minmax(0,1fr)] border-b border-border last:border-b-0"
                      >
                        ...
                        <div className="flex items-start border-r border-border p-3">
                          <div
                            className={`w-full border px-2 py-2 text-center rounded-none ${
                              rank === 1 ? "border-primary bg-primary/10" : "border-border bg-background/45"
                            }`}
                          >
                            <div className={`text-lg font-black ${rank === 1 ? "text-primary" : ""}`}>{confidence}%</div>
...
function Timeline({ track }: { track: Segment[] }) {
  const startHour = 8;
  const totalHours = 9;

  return (
    <div className="relative min-h-[132px] overflow-hidden p-3">
      <div className="absolute inset-0 grid grid-cols-10">
        {hours.map((hour) => (
          <div key={hour} className="border-r border-border/35 last:border-r-0" />
        ))}
      </div>

      <div className="relative h-[108px]">
        <div className="absolute left-0 right-0 top-[35px] h-px bg-border" />
        <div className="absolute left-0 right-0 top-[86px] h-px bg-border/70" />
          ...
          return (
            ...
            >
              <div className="relative h-[48px]">
                <div className={`absolute left-0 right-0 top-[22px] h-[3px] ${lineTone[segment.kind]}`} />
                <span className={`absolute left-0 top-[17px] h-[13px] w-[13px] -translate-x-1/2 rounded-full border-2 border-background ${lineTone[segment.kind]}`} />
                <span className={`absolute right-0 top-[17px] h-[13px] w-[13px] translate-x-1/2 rounded-full border-2 border-background ${lineTone[segment.kind]}`} />

                <div className="absolute left-0 right-0 top-0 overflow-visible px-1">
                  <div className="truncate text-[10px] font-black text-primary">{segment.id}</div>
                  <div className="truncate text-[11px] font-semibold">{segment.title}</div>
                </div>

                <div className="absolute left-0 top-[31px] whitespace-nowrap text-[9px] text-muted-foreground">
                  {segment.time}
                </div>
              </div>
            </div>
      ...
      <div className="mt-4 border-l-2 border-border pl-5">
        {items.map((item) => (
          <div key={`${item.time}-${item.id}`} className="relative pb-5 last:pb-0">
            <span className={`absolute -left-[27px] top-1 h-3 w-3 rounded-full border-2 border-background ${
              item.status === "OPEN" ? "bg-emerald-500" : item.status === "BREAK" ? "bg-amber-500" : "bg-primary"
            }`} />
