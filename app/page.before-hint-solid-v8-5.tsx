...
function TrackHint({
  ...
  return (
    <div className="pointer-events-none absolute left-1/2 z-[80] hidden w-60 -translate-x-1/2 border border-border bg-background p-3 text-foreground opacity-100 shadow-2xl group-hover:block group-focus-within:block">
