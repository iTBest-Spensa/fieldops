...
function TrackHint({
  ...
  return (
    <div className="pointer-events-none absolute left-1/2 z-[300] hidden w-60 -translate-x-1/2 border border-border p-3 text-foreground opacity-100 shadow-2xl group-hover:block group-focus-within:block">
...
function SingleLineTimeline({ track }: { track: Segment[] }) {
  ...
  return (
    <div className="relative min-h-[118px] overflow-visible px-3 py-2 hover:z-[200] focus-within:z-[200]">
